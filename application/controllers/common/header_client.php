...
class header_clientController extends Controller {
	...
	public function index() {
        ...
        $client = $this->user->isClient();
        $this->data['name'] = $client['last_name']." ".$client['name'];
        $this->data['balance'] = $client['balance'];
        
        $this->data['css'] = $this->config->css;
        $this->data['notes'] = $notes;
        
		return $this->load->view('common/header_client', $this->data);
	}
}
?>
