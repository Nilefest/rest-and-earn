...
<div class="block-win" style="width: 75%;">
    <div class="row">
        ...
        <div class="col-6 col-md-3">
            <div class="select-wrapper">
                ...
                <select name="rest_type" id="rest_type">
                    ...
                    <option <?php echo ($city['name'] == 'Киев'? 'selected' : ''); ?> value="<?php echo $type['name']; ?>">
                        <?php echo $type['name']; ?>
                    </option>
                    <?php endforeach; ?>
                </select>
    ...
    <div class="row rest_block" id="rest_block">
        <div class="col-11 col-lg-8 rest">
            <table>
                <div class="icons">
                    <img id="rem" src="/application/public/img/icon/rem.png" alt="<?php echo $row['id']; ?>.</td>" title="Rem">
                </div>
                <tr class="row">
                    <td class="num col-1">
                        <?php echo $n++; ?>.</td>
    ...
    <?php endforeach; ?>
    <div class="row">
        <a href="/rest/reg" class="button1">Добавить в список новое</a>
    </div>
</div>
    ...
    $("select#rest_type").change(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var n in rests) {
                    var block = '';
                    block += '<div class="row rest_block" id="rest_block"><div class="col-11 col-lg-8 rest"><table><tr class="row"><td class="num col-1">' + rests[n]['id'] + '.</td><td class="logo col-2"><img src="/application/public/img/logo_rest.png" alt="Логотип"></td><td class="info col-4"><div class="name">' + rests[n]['name'] + '</div><div class="type">' + rests[n]['type'] + '</div>'+
