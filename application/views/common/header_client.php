...
<body>
   <a href="" id="up" name="up"></a>
    <div class="container">
        <header class="row">
            <a class="to_main" href="/client">Назад</a>
            <img class="logo" src="/application/public/img/logo.png" alt="">
            <div class="block_info">
                <span><?php echo $name; ?><br>Баланс <?php echo $balance; ?></span><br>
                <a href="?logout" class="button2">ВЫЙТИ</a>
            </div>
        </header>
        <div class="content">
