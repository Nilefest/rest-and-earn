...
abstract class Model {
    ...
    public function getItems($column = array(), $data = array(), $nodata = array(), $sort = array(), $options = array(), $special = false) {
		$sql = "SELECT ";
    ...
    public function getMin($column = 'id', $group_by = false){
    ...
    public function getMax($column = 'id', $group_by = false){
    ...
    public function getSum($column = 'id', $group_by = false){
